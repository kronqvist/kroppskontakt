...
Self-improve this file. When a mistake, misunderstanding, or useful pattern surfaces during work, append a concise instruction here so future conversations avoid the same issue. Keep entries compact — every line must earn its place — but ensure enough context that a fresh conversation can orient itself without prior history.
